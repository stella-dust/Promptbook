/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cf97fab8e2ecd8452ed1d4f90f6d19a8)
// Runtime types generated with workerd@1.20260918.1 2026-09-20 nodejs_compat
interface __BaseEnv_Env {
	STAGING: R2Bucket;
	MEDIA: R2Bucket;
	ASSETS: Fetcher;
	SITE_ORIGIN: "https://junyiyan.com";
	BASE_PATH: "/projects/promptbook";
	GITHUB_REPOSITORY: "stella-dust/Promptbook";
	GITHUB_BRANCH: "main";
	R2_ACCOUNT_ID: "f5b3ac059cd23f67c6f19e9c71cd5332";
	STAGING_BUCKET_NAME: "promptbook-staging";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_ORIGIN" | "BASE_PATH" | "GITHUB_REPOSITORY" | "GITHUB_BRANCH" | "R2_ACCOUNT_ID" | "STAGING_BUCKET_NAME">> {}
}
declare module "*.html" {
	const value: string;
